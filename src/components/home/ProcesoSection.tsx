...
const ProcesoSection = () => (
  <section className="py-16 lg:py-24 bg-primary">
    <div className="container mx-auto px-4 lg:px-8 text-center">
      ...
      <p className="font-body text-lg lg:text-xl text-primary-foreground/80 max-w-3xl mx-auto mb-12 leading-relaxed fade-in">
      ...
      <Link
        to="/contacto"
        className="inline-block bg-primary-foreground text-primary font-body text-lg px-10 py-4 rounded-full hover:opacity-90 transition-opacity fade-in"
      >
        Pide Cita
      </Link>
    </div>
